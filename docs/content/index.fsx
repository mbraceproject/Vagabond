...
Vagrant attempts to solve this problem by providing an automated dependency resolution and 
...
and [FsPickler](http://nessos.github.io/FsPickler) libraries and adapts code from JB Evain's
...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The Vagrant library can be <a href="https://nuget.org/packages/Vagrant">installed from NuGet</a>:
      <pre>PM> Install-Package Vagrant</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
...
A collection of tutorials, technical overviews and API references of the library.
  ...
  * [API Overview](tutorial.html) An overview of the Vagrant API and examples.
